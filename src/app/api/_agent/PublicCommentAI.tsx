      ...
      messages: [
        {
          role: "system",
          content: `
あなたは与えられた法律文書のドラフトを分析し、この文書に関心を持つ可能性のある利害関係者（ステークホルダー）の役割を特定します。ステークホルダーは曖昧なものではなく、なるべく具体的で簡潔なペルソナを指定するようにしてください。例えば、「企業」ではなく「従業員数300人程度の食品生産工場の法務担当者」といったものや、「消費者」ではなく「アレルギーを持つ40代女性の消費者」といったものです。ステークホルダーには行政機関や政府機関などは含まずに、民間の個人や組織を対象としてください。
